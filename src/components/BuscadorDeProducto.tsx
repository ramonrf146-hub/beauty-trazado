...
export default function BuscadorDeProducto({
  ...
  return (
    <section className="rounded-3xl border border-line-dim bg-ink-2 p-6 sm:p-8">
      ...
      <p className="mt-2 text-sm text-text-dim">{dict["buscador.descripcion"]}</p>

      {resultado ? (
        <div className="mt-5">
          <p className="text-sm text-text-dim">{dict["buscador.resultadoIntro"]}</p>
          <div className="mt-4 flex items-center gap-4 rounded-2xl border border-line bg-ink p-4">
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate font-bold text-text-light">
                {t(resultado.nombre, resultado.nombreEn, locale)}
              </p>
        ...
        <div className="mt-5">
          <p className="mb-3 text-sm text-text-dim">{dict["buscador.elegirOpcion"]}</p>
