      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="grid gap-10 sm:grid-cols-3">
          <div>
            ...
            <p className="mt-3 max-w-xs text-sm text-text-dim">
              Recomendaciones de belleza y cuidado personal probadas de
              verdad, actualizadas seguido — sin relleno ni publicidad
              disfrazada de reseña.
            </p>
          </div>
        ...
        <div className="mt-10 border-t border-line-dim/40 pt-6">
          ...
          <p className="mt-4 text-xs text-text-dim/70">
            © {new Date().getFullYear()} BeautyLab. Todos los derechos
            reservados.
          </p>
        </div>
      </div>
