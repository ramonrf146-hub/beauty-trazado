...
const CLAVE_VISTO = "ct-disclosure-toast-visto";
  ...
  return (
    <>
      {mostrarToast && (
        ...
        >
          Como Afiliado de Amazon, BeautyLab gana por compras
          calificadas. Los precios están sujetos a confirmación en Amazon.
        </div>
      )}
      ...
      {mostrarInfo && (
        ...
        >
          ...
          BeautyLab es un participante en el Programa de Afiliados de
          Amazon Services LLC. Ganamos comisión por compras calificadas
          realizadas a través de nuestros enlaces, sin costo adicional para
          vos. Los precios mostrados son referenciales — el precio real solo
          se confirma en Amazon.
        </div>
      )}
    </>
  );
