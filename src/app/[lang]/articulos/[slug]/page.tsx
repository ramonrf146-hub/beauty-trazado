...
export default async function ArticuloPage({ params }: Props) {
  ...
  const articuloJsonLd = {
    ...
    author: { "@type": "Organization", name: "BeautyLab" },
    publisher: { "@type": "Organization", name: "BeautyLab" },
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <div
        className="prose prose-headings:font-semibold prose-a:text-line mt-8 max-w-none prose-headings:text-text-light prose-p:text-text-dim prose-li:text-text-dim prose-strong:text-text-light"
        ...
        <section className="mt-14 border-t border-line-dim/60 pt-10">
          <div className="flex items-center justify-between gap-4">
            <h2 className="text-xl font-semibold text-text-light">
              {dict["articulo.productosRelacionados"]}
            </h2>
            <Link
              href={withLocale(`/categorias/${categoria.slug}`, locale)}
