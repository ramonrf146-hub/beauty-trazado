...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `/productos/${producto.asin}`,
      languages: {
        ...
        <div className="mt-10 space-y-8 border-t border-line-dim/40 pt-8">
          ...
          <section>
            ...
            <ul className="mt-2 space-y-2 text-sm leading-relaxed text-text-dim">
              <li>
                <span className="font-semibold text-text-light">{dict["producto.enRutinaDiaria"]}</span>
                {guia.ejemploHogar}
              </li>
              <li>
                <span className="font-semibold text-text-light">{dict["producto.usoProfesional"]}</span>
                {guia.ejemploNegocio}
              </li>
            </ul>
          </section>
